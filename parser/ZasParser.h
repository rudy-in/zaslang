...
class  ZasParser : public antlr4::Parser {
public:
  enum {
  ...
  enum {
    RuleProgram = 0, RuleStatement = 1, RuleDisplayStatement = 2, RuleExpressionStatement = 3, 
    RuleVariableDeclaration = 4, RuleFunctionDefinition = 5, RuleParameterList = 6, 
    RuleParameter = 7, RuleTypeAnnotation = 8, RuleBlock = 9, RuleExpression = 10, 
    RuleComparison = 11, RuleTerm = 12, RuleFactor = 13, RuleFunctionCall = 14, 
    RuleArgumentList = 15, RuleIfStatement = 16
  };

  explicit ZasParser(antlr4::TokenStream *input);

  ZasParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);
  ...
  public:
    ...
    std::vector<DisplayStatementContext *> displayStatement();
    DisplayStatementContext* displayStatement(size_t i);
